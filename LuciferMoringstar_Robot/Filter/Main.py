...
async def filter(client, message):
    ...
    if 2 < len(message.text) < 100:    
        ...
        buttons.append(
            [InlineKeyboardButton(text="𝙽𝙴𝚇𝚃 𝙿𝙰𝙶𝙴 ››",callback_data=f"next_0_{keyword}")]
        )    
        buttons.append(
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            if int(index) == int(data["total"]) - 2:
                ...
                buttons.append(
                    [InlineKeyboardButton("‹‹ 𝙱𝙰𝙲𝙺 𝙿𝙰𝙶𝙴", callback_data=f"back_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                ...
                buttons.append(
                    [InlineKeyboardButton("‹‹ 𝙱𝙰𝙲𝙺 𝙿𝙰𝙶𝙴", callback_data=f"back_{int(index)+1}_{keyword}"),InlineKeyboardButton("𝙽𝙴𝚇𝚃 𝙿𝙰𝙶𝙴 ››", callback_data=f"next_{int(index)+1}_{keyword}")]
                )
                buttons.append(
                    [InlineKeyboardButton(f"🔖 𝙿𝙰𝙶𝙴𝚂 {int(index)+2}/{data['total']}", callback_data="pages")]
                )
            ...
            if int(index) == 1:
                ...
                buttons.append(
                    [InlineKeyboardButton("𝙽𝙴𝚇𝚃 𝙿𝙰𝙶𝙴 ››", callback_data=f"next_{int(index)-1}_{keyword}")]
                )
                buttons.append(
            ...
            buttons = [
                [
                    InlineKeyboardButton('⚜️ MAIN CHANNEL ⚜️', url=f'{TUTORIAL}')
                ]
                ]
